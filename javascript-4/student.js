...
let faveColors = ["orange", "teal", "red"];
// CODE HERE
...
let me = {
  firstName: "Luke",
  superHeroName: "blah man",
  homeTown: "new york",
  superPowers: ["fly", "generate code with bugs", "magic hammer not mijlonir"],
...
// CODE HERE
const setColor = arr => {
  let deleteLen = 2 - arr.length;
  if (arr.length > 3) arr.splice(2, deleteLen);
